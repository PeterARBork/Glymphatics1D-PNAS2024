...
sp = 3
glymph_density!("Dm", Cserr_chains, "10⁻² mm² / h", "PEG-900"; subplot=sp, scaleby=100.0, colorindex=3)
glymph_density!("Dm", Pla_chains, "10⁻² mm² / h", "Pla"; subplot=sp, scaleby=100.0, colorindex=lightorange)
...
v_prior = truncated(Normal(0.0, 0.5), -2.0, 2.0)
...
glymph_density!("D", Cserr_chains, "mm² / h", ""; subplot=7, color=PEG900_color, legend=false,)
glymph_density!("D", Cserr_PEG4000_chains, "mm² / h", ""; subplot=8, color=PEG4000_color, legend=false,)
glymph_density!("D", Cserr_albumin_chains, "mm² / h", ""; subplot=9, color=albumin_color, legend=false,)
p = plot!(
    D_PEG900,
    label="",
    color="gray",
...
glymph_density!("Dm", Cserr_chains, "mm² / h", ""; subplot=10, scaleby=100.0, xlims=(0.0, 0.3), yticks=nothing, color=PEG900_color)
glymph_density!("Dm", Cserr_PEG4000_chains, "mm² / h", ""; subplot=11, scaleby=100.0, xlims=(0.0, 0.3), yticks=nothing, color=PEG4000_color)
glymph_density!("Dm", Cserr_albumin_chains, "mm² / h", ""; subplot=12, scaleby=100.0, xlims=(0.0, 0.3), yticks=nothing, color=albumin_color)
plot!(xticks=[0.0, 0.1, 0.2, 0.3], subplot=10)
plot!(xticks=[0.0, 0.1, 0.2, 0.3], subplot=11)
plot!(xticks=[0.0, 0.1, 0.2, 0.3], subplot=12)
plot!(ylabel="", subplot=11)
plot!(ylabel="", subplot=12)

glymph_density!("v", Cserr_chains, "mm / h", ""; subplot=13, color=PEG900_color)
glymph_density!("v", Cserr_PEG4000_chains, "mm / h", ""; subplot=14, color=PEG4000_color)
glymph_density!("v", Cserr_albumin_chains, "mm / h", ""; subplot=15, color=albumin_color)
plot!(ylabel="", subplot=14)
plot!(ylabel="", subplot=15)
for i ∈ [13, 14, 15]
    plot!(
        v_prior,
        label="",
